...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      uploadDescription:
        'Supports single or batch file upload. Uploading prohibited files is strictly forbidden.',
      chunk: 'Chunk',
      bulk: 'Bulk',
      cancel: 'Cancel',
      close: 'Close',
...
Example: Virtual Hosted Style`,
    ...
    fileManager: {
      ...
      fileTypeFilter: 'File types',
      fileTypeFilterTip: 'Only files in the selected types can be uploaded.',
      fileCategoryPdf: 'PDF',
      fileCategoryDocument: 'Documents & data',
      fileCategoryAudio: 'Audio',
      fileCategoryMedia: 'Images & videos',
      fileTypeRejected: '{{name}} removed: its file type is not selected',
      uploadingBatch: 'Uploading batch {{current}} of {{total}}…',
      uploadingFile: 'Uploading: {{filename}}',
      uploadSpeed: '{{speed}} kB/s',
      uploadServerProcessing: 'Server processing and saving, please wait…',
      filesSelectedSummary: '{{total}} files selected (showing first {{shown}})',
      removeAllFiles: 'Clear all',
    },
    flow: {
